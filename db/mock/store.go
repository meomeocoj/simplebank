...
// Source: github.com/meomeocoj/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTransaction(arg0 context.Context, arg1 db.CreateTransferParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
